(function() {
    ...
    angular
        .module('app')
        .controller('DestinatairePromotionController', DestinatairePromotionController);

    DestinatairePromotionController.$inject = ['$scope', '$stateParams', 'Livraison', 'Magasin', 'Lot'];

    function DestinatairePromotionController ($scope, $stateParams,  Livraison, Magasin, Lot) {
        var vm = this;
       // vm.livraison = entity;
