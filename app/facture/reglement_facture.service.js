(function () {
    ...
    angular
            .module('app')
            .factory('ReglementFacture', ReglementFacture);

    ReglementFacture.$inject = ['$resource', 'DateUtils','API_URL'];

    function ReglementFacture($resource, DateUtils, API_URL) {

        console.log("dans ReglementFacture");
        var resourceUrl = API_URL+'api/reglement/facture-credit/';
