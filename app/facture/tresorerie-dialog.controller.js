(function () {
    ...
    ConfirmationTresorerieController.$inject = ['$timeout', '$scope', '$rootScope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'BonDeSortie', 'Magasin', 'User', 'Client', 'SweetAlert'];

    function ConfirmationTresorerieController($timeout, $scope, $rootScope, $stateParams, $uibModalInstance, $q, entity, BonDeSortie, Magasin, User, Client, SweetAlert) {
        var vm = this;
