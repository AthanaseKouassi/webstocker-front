(function() {
    ...
    angular
        .module('app')
        .controller('ValideVenteController', ValideVenteController);

    ValideVenteController.$inject = ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Commande', 'Livraison', 'Lignecommande', 'Bailleur', 'Fabricant'];

    function ValideVenteController ($scope, $stateParams, $uibModalInstance, entity, Commande, Livraison, Lignecommande, Bailleur, Fabricant) {
        var vm = this;
        vm.commande = entity;
