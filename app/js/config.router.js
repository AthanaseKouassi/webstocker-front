                        ...
                        $stateProvider
                                .state('app', {
                                    ...
                                    resolve: {
                                        authorize: ['Auth',
                                            function (Auth) {
                                                console.log("affaire de auth");
                                                return Auth.authorize();
                                            }
                                        ],
                                        translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                                                $translatePartialLoader.addPart('angulr');
...
//                    })
                                .state('menuachat', {
                                    ...
                                    views: {
                                        '@app': {
                                            templateUrl: 'menuachat/menuachat.html',
                                            controller: 'MenuachatController'
                                                    // controllerAs: 'vm'
                                        }
                                    }
                                })
                                ...
                                .state('menuvente', {
                                    ...
                                    views: {
                                        '@app': {
                                            templateUrl: 'menuvente/menuvente.html',
                                            controller: 'MenuventeController'
                                                    // controllerAs: 'vm'
                                        }
                                    }
                                })
                                ...
                                .state('menuactivite', {
                                    ...
                                    views: {
                                        '@app': {
                                            templateUrl: 'menuactivite/menuactivite.html',
                                            controller: 'MenuactiviteController'
                                                    // controllerAs: 'vm'
                                        }
                                    }
                                })
