 ...
 * Example of jsTestDriver.conf for running scenario tests with JSTD:
  <pre>
    ...
    server: http://83.166.138.228:9877
    ...
    proxy:
     ...
     - {matcher: "/your-prefix/*", server: "http://83.166.138.228:8000/"}
  </pre>
 *
 ...
 * That matches the proxy, so JSTD will proxy this request to http://83.166.138.228:8000/index.html.
 */
