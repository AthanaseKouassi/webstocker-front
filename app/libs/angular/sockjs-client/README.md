 ...
 * ws://83.166.138.228:8081/echo/websocket
...
This will start [zuul](https://github.com/defunctzombie/zuul) and a test support server. Open the browser to [http://83.166.138.228:9090/_zuul](http://83.166.138.228:9090/_zuul) and watch the tests run.
