(function() {
    ...
    JhiTrackerService.$inject = ['$rootScope', '$window', '$cookies', '$http', '$q', 'AuthServerProvider','API_URL'];

    function JhiTrackerService ($rootScope, $window, $cookies, $http, $q, AuthServerProvider,API_URL) {
...
//            var url =  'http://83.166.138.228:8080/'+ 'websocket/tracker';
//            var url =  'http://localhost:8080/'+ 'websocket/tracker';
