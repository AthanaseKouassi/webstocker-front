(function() {
    ...
    angular
        .module('app')
        .controller('BonDeSortieWizardController', BonDeSortieWizardController);

    BonDeSortieWizardController.$inject = ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Commande', 'Livraison', 'Lignecommande', 'Bailleur', 'Fabricant'];

    function BonDeSortieWizardController ($scope, $stateParams, $uibModalInstance, entity, Commande, Livraison, Lignecommande, Bailleur, Fabricant) {
        var vm = this;
        vm.commande = entity;
